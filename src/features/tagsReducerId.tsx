...
export const fetchTags = createAsyncThunk(
  ...
  async ({ page, perPage, reset = false }) => {
    const response = await axios.get('http://localhost:5000/api/tags-id/tags', {
  ...
  async (tag, { rejectWithValue }) => {
    try {
      const response = await axios.get(
        `http://localhost:5000/api/tags-id/${tag}/Pantip Trend`,
      );
...
export const fetchAnnounce = createAsyncThunk(
  ...
  async (tag, { rejectWithValue }) => {
    try {
      const response = await axios.get(
        `http://localhost:5000/api/tags-id/${tag}/Announce`,
      );
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response.data);
...
export const fetchRecommendations = createAsyncThunk(
  ...
  async (tag: string, { rejectWithValue }) => {
    try {
      const response = await axios.get(
        `http://localhost:5000/api/tags-id/${tag}/กระทู้แนะนำโดยสมาชิก`,
      );
      return response.data;
    } catch (error) {
...
export const fetchLatestPosts = createAsyncThunk(
  ...
  async (tag, { rejectWithValue }) => {
    try {
      const response = await axios.get(
        `http://localhost:5000/api/tags-id/${tag}/กระทู้ล่าสุด`,
      );
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response.data);
...
export const fetchPantipPick = createAsyncThunk(
  ...
  async (tag, { rejectWithValue }) => {
    try {
      const response = await axios.get(
        `http://localhost:5000/api/tags-id/${tag}/Pantip Pick`,
      );
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response.data);
